...
@section('content')
    ...
    <body>
    <form  action="/adds" method="post" role=" form ">
        {{csrf_field()}}
        ...
        <div class="row">
            <div id="carouselHacked" class="carousel slide carousel-fade" data-ride="carousel">
                ...
                <div style="padding-top:70px; ">
                    ...
                    @foreach($doctor_reqs as $doctor_req)
                            <div style="padding-left: 50px;padding-right: 50px" >
<table
       @if($doctor_req->id % 2 == 0)
style="background-color: #4e555b;color: gold"
    ...
    <tr>
                                <li>
       <td>
           <h3 class="requestdoctor">| id : {{$doctor_req->id}} |</h3>
           <h3 class="requestdoctor">| name : {{$doctor_req->name}} |</h3>
    <h3 class="requestdoctor">| country : {{$doctor_req->country}} |</h3>
    <h3 class="requestdoctor">| phone : {{$doctor_req->phone}} |</h3>
    <h3 class="requestdoctor">| email : {{$doctor_req->email}} |</h3>
    <h3 class="requestdoctor">| study : {{$doctor_req->study}} |</h3>
    <h3 class="requestdoctor">| university_name : {{$doctor_req->university_name}} |</h3>
    <h3 class="requestdoctor">| experience_year : {{$doctor_req->experience_year}} |</h3>
    <h3 class="requestdoctor">| additional_data : {{$doctor_req->additional_data}} |</h3>
       </td>
                                </li>
    <br>
    </tr>
...
<h3> please enter the numper of the request you want </h3>
...
<br>
                        <button type="submit" style="font-size: large;margin-right: 40px" > confirm </button>
