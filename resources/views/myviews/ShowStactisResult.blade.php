...
<tr>
<td>
        <label class="requestdoctor"> illness name : {{$result->illness_name}}</>
    </td><td>
        <label class="requestdoctor"> illness numbers : {{$result->illness_numbers}}</label>
    </td>
    @foreach($result->illness_country as $r )
   <td>
       <label class="requestdoctor">   {{$r}}</label>
   </td>
