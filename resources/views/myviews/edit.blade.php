...
<form  action="/edita" method="post" role="form">
    ...
    <legend  style="text-align: center;font-size:60px;color: red">edite illness</legend>

<h3>the id </h3>
        <input  style="font-size: 20px" type="number"  name="id" value="{{$illness->id}}" placeholder="Enter the id..."></input><br>

        <h3> the name of ill</h3>

        <input style="font-size: 20px" type="text"  name="name" id="name" value="{{$illness->name}}" placeholder="Enter the name...">
        </input><br>
        <h3> the temperature value</h3>
        <input  style="font-size: 20px" type="number"  name="temperature" value="{{$symptom->temperature}}" placeholder="Enter the temp..."></input><br>
            ...
            <table align="center" border="1" >
                ...
                <tr>
                    <td>
                        ...
                        @if( $symptom->loss_tasty_or_smell == 1 )
                            <label  style="text-align: center;font-size: large "   type="text">
                                yes</label> @else  <label  style=" text-align: center;font-size: large "   type="text">
                            no </label> @endif
                ...
                <tr>
                    <td>
                        ...
                        @if( $symptom->dizzy == 1 )
                            <label  style="text-align: center; "   type="text">
                                yes</label> @else  <label  style=" text-align: center;"   type="text">
                            no </label> @endif
