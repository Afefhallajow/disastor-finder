...
<
    <div align="center" style="width: 400px; text-align: center;background-color: whitesmoke ;margin-top: 175px" >

        <h2 class="requestdoctor"> id : {{$ills->id}}</h2>
                </td>
                <td><br>
                <h2 class="requestdoctor"> name : {{$ills->name}}</h2><br>
                </td>
                <td>
                <h2 class="requestdoctor"> sypmtom_id : {{$symptom->id}}</h2>
                </td><br>
                <td>
                <h2 class="requestdoctor"> temp : {{$symptom->temperature}}</h2>
                </td><br>
            </li>
        </tr>
    </table>
