...
<body class="afef">
<form  action="/sta" method="post" role="form">
    {{csrf_field()}}
   ...
   <section>
    ...
    <div style="text-align: center;padding-top: 175px" >
        <legend  style="text-align: center;font-size:60px;color: red">show illness statics</legend>
        <table align="center" border="1">
        <tr>
            <td>
            <label>please enter the year</label><br>
        <input style="font-size: 20px" type="text" class="trol" name="year"  placeholder="Enter the year...">
        </input></td><td>
        <label>please enter the month</label><br>
        <input style="font-size: 20px" type="text" class="" name="month"  placeholder="Enter the month...">
        </input></td>
<td>
        <label>please enter the day</label><br>
        <input style="font-size: 20px" type="text" class="" name="day"  placeholder="Enter the day...">
        </input></td></tr>
...
<td>
    <h1 style="color: black">sss</h1>
            ...
            <tr>
                <td>
        <label>please enter the hour</label>
        <input style="font-size: 20px" type="text" class="" name="hour"  placeholder="Enter the hour...">
        </input></td><td>
        <label>please enter the country</label>
        <input style="font-size: 20px" type="text" class="" name="country"  placeholder="Enter the country...">
        </input></td><td>
        <label>please enter the illness name</label><input style="font-size: 20px" type="text"  name="illness_name"  placeholder="Enter the name...">
        </input><br></td>
            </tr>
        </table>
    <button style="font-size: 40px;margin: 20px" type="submit">confirm</button>
    </div>
