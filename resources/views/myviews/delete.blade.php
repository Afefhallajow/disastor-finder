...
<body class="afef">
<form  action="/del" method="post" role="form">
                    ...
                    <nav class="navbar navbar-default">
                        <div class="container-fluid nav-bar">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                ...
                                @if (Route::has('login'))
                                    <div class="p-0 right-0 px-6 py-4 sm:block">
                                        @auth
                                        @else
    ...
    <div style="text-align: center;padding-top: 175px" >
        ...
        <legend  style="text-align: center;font-size:60px;color: red">delete illness</legend>
        <h1>please enter the name of ill</h1>

        <input style="font-size: 20px" type="text" class="" name="name" id="name"  placeholder="Enter the name...">
        </input><br>

        <div  style="text-align: center ;">
            <button   style="margin-top:200px;font-size: 30px;background-color: black;color: red" type="submit" class="btn btn-primary">Confirm</button>
        </div>
    </div>
</form>
